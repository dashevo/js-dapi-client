...
class GrpcTransport {
   ...
   */
  constructor(createAddressProviderFromOptions, addressProvider, globalOptions) {
  ...
  async request(ClientClass, method, requestMessage, options = { }) {
    ...
    options = {
      ...
      deadline: this.globalOptions.deadline,
      ...options,
    };
    ...
    if (options.deadline !== undefined) {
      requestOptions.deadline = options.deadline;
    }
