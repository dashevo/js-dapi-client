...
const txId = '89e3b3b4f62957ea94234293de9e01b3d509d5db67663c97d8369d018488bd12';

describe('Accounts - Login', () => {
  it('should authenticate with a server', () => SDK.Accounts.API.User.login(txId, privKey)
  ...
  it('should not auth with a server for invalid private key', () => {
