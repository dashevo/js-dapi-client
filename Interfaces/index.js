...
const client = jayson.client.http('http://172.30.30.239:4019');
...
module.exports = {
  ...
  createUser(username, pubKey, privateKey) {
    const accData = {
  ...
  payContact(privateKey, toUsername, xPubkey, dapId) {
  ...
  getUserState(username, dapId, height) {
    return client.request('getUserState', {
      uname: `${username}`,
      dapId: `${dapId}`,
      height: `${height}`,
