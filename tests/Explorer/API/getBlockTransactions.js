...
describe('Insight-API - getBlockTransactions', () => {
  it('should return the valid getBlockTransactions from hash', () => SDK.Explorer.API.getBlockTransactions(validBlockHash)
    .then(blockTransactions => blockTransactions.should.deepEqual(txArr))
    .catch(err => console.log(err)));
  it('should return the valid getBlockTransactions from height', () => SDK.Explorer.API.getBlockTransactions(validBlockHeight)
    .then(blockTransactions => blockTransactions.should.deepEqual(txArr))
    .catch(err => console.log(err)));
});
