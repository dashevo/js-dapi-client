...
// TODO: Work out some way to deal with the absurdly long test names, probably move out data to JSON
/**
...
const start = async () => {
  ...
  //   await SDK
  //     .Explorer
  //     .getTx('dce49c9e92b1ba673dc7c2822c509c3850e09b4da766413bfd2051565ca1d396');
  ...
  // const bwsutxo =
  //   await SDK.BWS
  //     .getUtxos('nada', ['yb21342iADyqAotjwcn4imqjvAcdYhnzeH', 'yUGETMg58sQd7mTHEZJKqaEYvvXc7udrsh']);
  // const bwstx =
  //   await SDK.BWS.BWS
  //     .getTx()('65d4f6369bf8a0785ae05052c86da4a57f76866805e3adadc82a13f7da41cbdf', (err, x) => { console.log('bws tx', x); });
  // const bwsbal =
  //   await SDK.BWS.BWS
  //     .getBalance()('yj6xVHMyZGBdLqGUfoGc9gDvU8tHx6iqb4', (err, x) => { console.log('bws balance', x); });
  // const bwssend = await SDK.BWS.broadcastRawTx(1, 1, '', (err, x) => { console.log('bws balance', x); }); // other params
  // const bwstxhist = await SDK.BWS.BWS.getTxHistory()({}, 0, 10, true, (err, x) => { console.log('bws txhist', x); });
  // const bwsFiatRate = await SDK.BWS.BWS.getFiatRate()({}, {}, {}, {}, (err, x) => { console.log('bws fiat rate', x); }); // other params
  //
  // const bwsAddy = await SDK.BWS.BWS.getMainAddress()({}, {}, 10, {}, (err, x) => { console.log('bws mainaddy', x); }, {}, 'inflict about smart zoo ethics ignore retire expand peasant draft sock raven');
