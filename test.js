 ...
 */
 // import getMNlist from './Explorer/insightAPI/getStatus'
 var status = require('./Explorer/insightAPI/getStatus');
...
async function start(){
    ...
    let mnlist = await SDK.Explorer.API.getMNlist();
    console.log(86, mnlist)
