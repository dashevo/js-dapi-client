...
describe('Insight-API - getBlock', () => {
  it('should return the valid block from hash', () => SDK.Explorer.API.getBlock(validBlockHash)
    .then((block) => {
  ...
  it('should return the valid block from height', () => SDK.Explorer.API.getBlock(validBlockHeight)
    .then((block) => {
      block.should.have.property('hash');
      block.should.have.property('size');
      block.should.have.property('height');
