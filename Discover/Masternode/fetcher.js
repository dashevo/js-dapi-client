...
const axios = require('axios'),
  SpvUtils = require('../../src/util/SpvUtils'),
  _ = require('lodash'),
  fs = require('fs');
...
getUri = () => `http://${_.sample(SDK.Discover.Masternode.masternodeList.nodes).ip}`;

getMnLists = () => new Promise((resolve, reject) => axios.get(`${getUri()}/masternodes/updateList/${SDK.Discover.Masternode.masternodeList.hash}`)
  .then((res) => {
    resolve(res.data);
  })
  .catch((err) => {
...
exports.fetcher = ns => new Promise((resolve, reject) => {
